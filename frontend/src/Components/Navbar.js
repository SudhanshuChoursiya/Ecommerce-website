  ...
  return (
    ...
    >
      <div className={styles.logo__container}>
        <Image src="/Shoping-logo.svg" height={31} width={31} alt="logo" />
        <h1>Ecomerce Shop</h1>
      </div>
      ...
      <div className={styles.search__container}>
        <form onSubmit={searchProducts}>
          ...
          <span className={styles.search__btn} onClick={searchProducts}>
      ...
      <div className={styles.cart__icon__container}>
        <Link href="/cart">
          <div className={styles.cart__icon__wrapper}>
            ...
            <div className={styles.cart__count}>{cartItem.length}</div>
          </div>
        </Link>
      </div>
